...
const Hero = () => {
  ...
  return (
   ...
   <div className="ralative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28">
...
{statistics.map((stat, index) => (
  <div key={stat.label}>
   ...
   items-center xl:min-h-screen max-xl:py-40 bg-primary bg-cover bg-hero bg-center">
    <img src={bigShoe1} 
    alt="shoe collection"
    width={610}
    height={5000}
